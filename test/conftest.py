...
class FakeRegularBoxData:
    ...
    def prepare_txt_img(self):
        ...
        data = [
            ...
            ('5.txt', [], [(0, 0.7, 0.4, 0.17, 0.17, 0.816), (0, 0.7, 0.4, 0.2, 0.2, 0.852),
                           (0, 0.68, 0.4, 0.2, 0.2, 0.835), (1, 0.3, 0.4, 0.2, 0.3, 0.672),
                           (1, 0.3, 0.4, 0.22, 0.26, 0.583)]),
...
class FakeRotatedBoxData(FakeRegularBoxData):
    ...
    def prepare_txt_img(self):
        ...
        data = [
            ...
            ('5.txt', [],
             [(0, 0.55, 0.415, 0.715, 0.445, 0.685, 0.6125, 0.52, 0.5825, 0.816),
              (0, 0.5375, 0.3975, 0.735, 0.4325, 0.7, 0.63, 0.5025, 0.595, 0.852),
              (0, 0.5175, 0.395, 0.715, 0.43, 0.68, 0.6275, 0.4825, 0.5925, 0.835),
              (1, 0.1525, 0.28, 0.35, 0.315, 0.2975, 0.61, 0.1, 0.575, 0.672),
              (1, 0.14, 0.2975, 0.355, 0.335, 0.31, 0.5925, 0.095, 0.5525, 0.583)]),
            ('6.txt', [],
             [(0, 0.5375, 0.3975, 0.735, 0.4325, 0.7, 0.63, 0.5025, 0.595, 0.852),
